...
public final class AdBrowserLayout extends RelativeLayout {
    ...
    public AdBrowserLayout(Context context) {
        ...
        int buttonWidth = UtilKScreen.getCurrentScreenWidth() / 5;
        LayoutParams buttons_params =
                new LayoutParams(buttonWidth, ViewGroup.LayoutParams.MATCH_PARENT);

        int size = UtilKDisplay.dp2px(HEADER_HEIGHT_DP) / 2;
    ...
    private void configFooterView() {
        LayoutParams footer_params =
                new LayoutParams(LayoutParams.MATCH_PARENT, UtilKDisplay.dp2px(HEADER_HEIGHT_DP));
    ...
    private void configBackButton(Context context, LinearLayout buttonsContainer,
        ...
        if (Build.VERSION.SDK_INT < 16) {
            mBackBtn.setBackgroundDrawable(UtilKBase64.str2BitmapDrawable(mBase64Drawables.getBackInactive()));
        } else {
            mBackBtn.setBackground(UtilKBase64.str2BitmapDrawable(mBase64Drawables.getBackInactive()));
        }
    ...
    private void configRefreshButton(Context context, LinearLayout buttonsContainer,
        ...
        if (Build.VERSION.SDK_INT < 16) {
            mRefreshBtn.setBackgroundDrawable(UtilKBase64.str2BitmapDrawable(mBase64Drawables.getRefresh()));
        } else {
            mRefreshBtn.setBackground(UtilKBase64.str2BitmapDrawable(mBase64Drawables.getRefresh()));
        }
    ...
    private void configNativeButton(Context context, LinearLayout buttonsContainer,
        ...
        if (Build.VERSION.SDK_INT < 16) {
            mNativeBtn.setBackgroundDrawable(UtilKBase64.str2BitmapDrawable(mBase64Drawables.getNativeBrowser()));
        } else {
            mNativeBtn.setBackground(UtilKBase64.str2BitmapDrawable(mBase64Drawables.getNativeBrowser()));
        }
    ...
    private void configCloseButton(Context context, LinearLayout buttonsContainer,
        ...
        if (Build.VERSION.SDK_INT < 16) {
            mCloseBtn.setBackgroundDrawable(UtilKBase64.str2BitmapDrawable(mBase64Drawables.getClose()));
        } else {
            mCloseBtn.setBackground(UtilKBase64.str2BitmapDrawable(mBase64Drawables.getClose()));
        }
